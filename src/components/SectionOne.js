...
function SectionOne() {
  return (
    ...
    <div className='max-w-7xl mt-10 mx-auto relative ' >
        ...
        <img  src={SecOneMob} className='max-w-7xl mx-auto h-full sm:hidden'></img>
        <div className='absolute w-full h-fit top-20 flex flex-col font-medium  '>
            <span className='mx-auto hidden sm:flex'><img src={LogoMob} className='w-28'></img></span>
            <span className='text-[#FFFFFF] text-xl max-w-xs sm:max-w-lg text-center mt-12 mx-auto'>Cross-chain interoperability made easy with our automation middleware.</span>
    ...
    <p className='font-black text-[#FFFFFF] sm:text-5xl text-xl max-w-xs sm:max-w-2xl mx-auto text-left sm:text-center'>
        Designed to seamlessly connect and automate cross-chain interactions for a truly interconnected blockchain ecosystem
        </p>
    </div>
    <div className='sm:mt-24 mt-10 w-full'>
    <p className='font-medium text-[#838383] sm:text-xl text-base max-w-xs sm:max-w-7xl mx-auto text-left sm:text-center '>
