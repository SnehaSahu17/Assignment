  ...
  return (
    <div className=" sm:w-[90%] mt-44 relative mx-auto leading-8 tracking-wide ">
        ...
        <div className='absolute top-[15%] flex flex-col text-[#FFFFFF] '>
                    <h1 className='font-black max-w-xs sm:max-w-7xl text-[#DFFFF3] text-center text-4xl sm:text-5xl mx-auto'>For Developers by Developers</h1>
                    <p className='font-medium text-xl max-w-xs sm:max-w-7xl mt-8 sm:w-1/2 text-center mx-auto'>Discover our comprehensive API documentation, designed specifically with developers in mind. Gain insights, learn best practices, and explore the full potential of our platform to elevate your projects with ease and efficiency.</p>
